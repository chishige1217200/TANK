...
public class Bullet : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rend[0] = GameObject.Find("BPS").GetComponent<Renderer>(); //Particle System情報の取得
        rend[1] = GameObject.Find("BPS2").GetComponent<Renderer>();
        rend[2] = GameObject.Find("BPS3").GetComponent<Renderer>();
        rend[3] = GameObject.Find("Burst").GetComponent<Renderer>();
        rend[4] = GameObject.Find("RPS").GetComponent<Renderer>();
